...
<div id="mySidepanel" class="sidepanel">
    ...
    <button><span class="delay" id="hide_camera" style="display: none;">Hide Camera</span></button>

    <!-- Dropdown list of available cameras -->
    <select class="delay" id="camera_select" style="display: none;"></select>
...
<div id="main">
    <video id="client_qr_CAMERA" alt="QR Scanner" style="margin-top: 4em;"></video>
</div>
