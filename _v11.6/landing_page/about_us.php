...
<body>
    ...
    <main class="main2">
        <section>
            ...
            <div class="line2"></div>
            <div class="member1">
                <div class="text1-1">Marcus Dex Vibar</div>
                <div class="text2-1">Project Manager | Front End Dev | Back End Dev</div>
                <img class="image1" src="assets\img\marcus.jpg" alt="Random Image">
            </div>
            <div class="member2">
                <div class="text1-2">Jairus Rain Mendoza</div>
                <div class="text2-2">Assitant Project Manager | Front End Dev</div>
                <img class="image2" src="assets\img\marcus.jpg" alt="Random Image">
            </div>
            <div class="member3">
                <div class="text1-3">Justin Luague</div>
                <div class="text2-3">Lead Documentarian</div>
                <img class="image3" src="assets\img\marcus.jpg" alt="Random Image">
            </div>
            <div class="member4">
                <div class="text1-4">Leonard Dave Mendoza</div>
                <div class="text2-4">Documentarian</div>
                <img class="image4" src="assets\img\marcus.jpg" alt="Random Image">
            </div>
            <div class="member5">
                <div class="text1-5">Lisandro Zabalo</div>
                <div class="text2-5">Documentarian</div>
                <img class="image5" src="assets\img\marcus.jpg" alt="Random Image">
            </div>
        </section>
    </main>
    <main class="main3">
